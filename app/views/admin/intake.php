...
<div class="card card-pad ed-card">
  ...
  <p class="mute ed-note">An email, a password and a domain make an account. Nothing is read from
    the domain yet — that is the <strong>Build listing</strong> button in the queue below, one
...
<div class="card card-pad ed-card">
  ...
  <?php if (!$queue): ?>
    <p class="mute" style="margin:0">Nobody yet. Members added above — or through the API below — appear here.</p>
  <?php else: ?>
...
<div class="card card-pad ed-card">
  ...
  <p class="mute ed-note">The same thing from somewhere else. It creates the account only; the
    listing is still built from the queue above.</p>
